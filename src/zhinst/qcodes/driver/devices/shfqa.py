...
class Generator(ZINode):
    ...
    def configure_sequencer_triggering(
        ...
        """Configure the sequencet triggering.
...
class Readout(ZINode):
    ...
    def read(self, *, timeout: float = 10) -> np.array:
        ...
        Args:
            time_out: maximum time to wait for data in seconds (default = 10s)
...
class SHFScope(ZINode):
    ...
    def run(
        ...
        Raises:
            TimeoutError if the Scope could not started within the specified
                timeout.
        """
        return self._tk_object.run(
